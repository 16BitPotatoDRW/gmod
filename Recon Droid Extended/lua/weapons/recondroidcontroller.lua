...
SWEP.Instructions = "Left click to take control. Right Click to release it. Right Click again if you get stuck."
SWEP.Category = "Other"
...
SWEP.WElements = {
	["we"] = { 
		type = "Model",
		model = "models/props_phx/rt_screen.mdl", //models/lt_c/sci_fi/holo_tablet.mdl
		bone = "ValveBiped.Bip01_R_Hand",
		rel = "",
		pos = Vector(4, 6, 2),
		angle = Angle(200, 10, 0),
		size = Vector(0.2, 0.15, 0.15),
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_R_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(5, 10, 2) },
	
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(40, 30, 0) },
...
function SWEP:Think()
	...
	if !IsValid(self.Owner.droid) and self.Owner.ispilot ==true then
	self.Owner:SetNWBool("CameraPOV",false)
	self.Owner:SetMoveType(MOVETYPE_WALK)
	self.Owner.ispilot = false
	return end
...
if !IsValid(self.Owner.droid) then
	self.Owner:SetNWBool("CameraPOV",false)
	self.Owner:SetMoveType(MOVETYPE_WALK)
	self.Owner.ispilot = false
	return end
...
function SWEP:Holster()
	if self.Owner.ispilot==true then
		self.Owner:SetNWBool("CameraPOV",false)
		self.Owner:SetMoveType(MOVETYPE_WALK)
		self.Owner.ispilot = false 
		end
